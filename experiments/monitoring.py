"""
Utilities used for monitoring training.
"""
import os
import pickle
...
class CustomCallback(BaseCallback):
    ...
    Used for plugging into a stable_baselines3 algorithm.
    ...
    def __init__(
        ...
        self.save_dir = f"{self.save_directory}/{self.experiment_name}"
    ...
    def checkpoint(self):
        filename = f"{self.save_dir}/model{self.n_calls}.zip"
    ...
    def sample_model(self):
        ...
        filename = f"{self.save_dir}/recordings{self.n_calls}.pcl"
